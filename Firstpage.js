...
const Firstpage = () => {
  ...
  return (
    <form onSubmit={handleSubmit} id="firstpage" className="bg-gray-800 p-8 rounded-lg shadow-lg max-w-lg w-full">
      {/* Hero Section */}
      <br/><br/><br/>
      <h3 className="text-2xl font-bold mb-4 text-white">Hero Section</h3>
      <input
        type="text"
        name="name"
        value={formData.name}
      ...
      {/* Contact Info */}
      <h3 className="text-2xl font-bold mt-4 mb-4 text-white">Contact Info</h3>
      <input
        type="email"
        name="email"
      ...
      {/* Skills Section */}
      <h3 className="text-2xl font-bold mt-4 mb-4 text-white">Skills</h3>
      <select
        name="name"
        value={newSkill.name}
      ...
      {/* Experience Section */}
      <h3 className="text-2xl font-bold mt-4 mb-4 text-white">Experience</h3>
      <input
        type="text"
        name="role"
      ...
      <input
        ...
        onChange={handleExperienceChange}
        placeholder="Period(ex: 2022-present)"
        className="mt-1 block w-full bg-gray-700 border-gray-600 rounded p-2"
      />
      <textarea
        name="description"
      ...
      {/* Projects Section */}
      <h3 className="text-2xl font-bold mt-4 mb-4 text-white">Projects</h3>
      <input
        type="text"
        name="title"
      ...
      {projectList.map((edu, index) => (
        <div key={index} className="mt-2 p-2 bg-gray-700 rounded">
          <p>{edu.title} at {edu.description}</p>
      <button 
      ...
      {/* Education Section */}
      <h3 className="text-2xl font-bold mt-4 mb-4 text-white">Education</h3>
      <input
        type="text"
        name="school"
      ...
      {/* About Me Section */}
      <h3 className="text-2xl font-bold mt-4 mb-4 text-white">About Me</h3>
      <input
        type="text"
        name="name"
      ...
      <h3 className="text-2xl font-bold mt-4 mb-4 text-white">Certificates</h3>
      <input
        type="text"
        name="title"
      ...
      {certificateList.map((cert, index) => (
        <div key={index} className="mt-2 p-2 bg-gray-700 rounded">
          <p>{cert.title} from {cert.issuer}</p>
          <button 
